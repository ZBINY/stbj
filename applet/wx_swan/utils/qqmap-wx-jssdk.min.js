var _createClass = function () {
  ...
  if (!(a instanceof b)) {
    ...
    swan.getLocation({ type: "gcj02", success: c, fail: b, complete: a });
  ...
  function b(i) {
    _classCallCheck(this, b);if (!i.key) {
      ...
      var l = this;i = i || {};Utils.polyfillParam(i);if (!Utils.checkKeyword(i)) {
        ...
        k.boundary = "nearby(" + o.latitude + "," + o.longitude + "," + n + "," + j + ")";swan.request(Utils.buildWxRequestConfig(i, { url: URL_SEARCH, data: k }));
      ...
      var k = this;i = i || {};Utils.polyfillParam(i);if (!Utils.checkKeyword(i)) {
        return;
      }var j = { keyword: i.keyword, region: i.region || "全国", region_fix: i.region_fix || 0, policy: i.policy || 0, output: "json", key: k.key };swan.request(Utils.buildWxRequestConfig(i, { url: URL_SUGGESTION, data: j }));
      ...
      var k = this;i = i || {};Utils.polyfillParam(i);var j = { coord_type: i.coord_type || 5, get_poi: i.get_poi || 0, output: "json", key: k.key };if (i.poi_options) {
        ...
        j.location = m.latitude + "," + m.longitude;swan.request(Utils.buildWxRequestConfig(i, { url: URL_GET_GEOCODER, data: j }));
      ...
      var k = this;i = i || {};Utils.polyfillParam(i);if (Utils.checkParamKeyEmpty(i, "address")) {
        return;
      }var j = { address: i.address, output: "json", key: k.key };swan.request(Utils.buildWxRequestConfig(i, { url: URL_GET_GEOCODER, data: j }));
    } }, { key: "getCityList", value: function c(i) {
      var k = this;i = i || {};Utils.polyfillParam(i);var j = { output: "json", key: k.key };
      swan.request(Utils.buildWxRequestConfig(i, { url: URL_CITY_LIST, data: j }));
    } }, { key: "getDistrictByCityId", value: function d(i) {
      var k = this;i = i || {};Utils.polyfillParam(i);if (Utils.checkParamKeyEmpty(i, "id")) {
        return;
      }var j = { id: i.id || "", output: "json", key: k.key };swan.request(Utils.buildWxRequestConfig(i, { url: URL_AREA_LIST, data: j }));
      ...
      var k = this;i = i || {};Utils.polyfillParam(i);if (Utils.checkParamKeyEmpty(i, "to")) {
        ...
        j.from = m.latitude + "," + m.longitude;swan.request(Utils.buildWxRequestConfig(i, { url: URL_DISTANCE, data: j }));
      };if (i.from) {
        i.location = i.from;
      }Utils.locationProcess(i, l);
    } }]);return b;
