;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box .btn{background:#fff;overflow:hidden;}'+
                '.sel-box .btn1{overflow:hidden;width:35px;height:22px;float:left;padding:11px 12px;}'+
                '.sel-box .btn1 img{float:left;width:100%;height:100%;}'+
                '.sel-box .ok{float:right;}'+
                '.sel-box .name{color:#000;text-align:center;line-height:22px;font-size:18px;padding:11px 0;}'+
                '.sel-con{background:white;}'+
                '.sel-con .border{height:34px;border:solid 1px #c31419;border-width:1px 0;position:fixed;bottom:72px;left:0;right:0;pointer-events:none;}'+
                ...
                '<div class="btn1 ok" style="font-size: 16px;color: #ca1025;">确定</div>'+
                '<div class="btn1 cancel" style="font-size: 16px;color: #666;">取消</div>'+
